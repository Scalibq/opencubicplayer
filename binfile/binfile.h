...
// derived methods
  ...
  unsigned char getuc();
  short gets();
  unsigned short getus();
  long getl();
  unsigned long getul();

  short getss();
  unsigned short getsus();
  long getsl();
  unsigned long getsul();

  void putc(char);
  void putsc(signed char);
  void putuc(unsigned char);
  void puts(short);
  void putus(unsigned short);
  void putl(long);
  void putul(unsigned long);

  void putss(short);
  void putsus(unsigned short);
  void putsl(long);
  void putsul(unsigned long);
...
#endif
uintm getu1(binfile &f);
uintm getul2(binfile &f);
...
#endif
uintm peeku1(binfile &f);
uintm peekul2(binfile &f);
