...
//
// WMAPlay interface routines (based on WAVPlay)
//
...
static void wavDrawGStrings(short (*buf)[132])
{
  if (plScrWidth==80)
  {
    ...
    writestring(buf[0], 56, 0x09, " buf: ---%   ptch: ---% ", 24);
    ...
    writenum(buf[0], 62, 0x0F, wmaplaybufperc, 10, 3);
    ...
    writenum(buf[1], 29, 0x0F, (inf.len>>(10-inf.stereo-1)), 10, 6, 1);
    writenum(buf[1], 14, 0x0F, (inf.pos>>(10-inf.stereo-1)), 10, 6, 1);
    ...
    writestring(buf[2],  0, 0x09, "    wma úúúúúúúú.úúú: ...............................               time: ..:.. ", 80);
  ...
  else
  {
    ...
    writestring(buf[0], 102, 0x09,  " buffer: ---%  pitch: ---%    ", 30);
    ...
    writenum(buf[0], 111, 0x0F, wmaplaybufperc, 10, 3);
    ...
    writenum(buf[1], 36, 0x0F, (inf.len>>(10-inf.stereo-1)), 10, 6, 1);
    writenum(buf[1], 21, 0x0F, (inf.pos>>(10-inf.stereo-1)), 10, 6, 1);
    writenum(buf[1], 65, 0x0F, inf.rate, 10, 5, 1);
    writenum(buf[1], 74, 0x0F, 8<<1, 10, 2, 1);
    ...
    writestring(buf[2],  0, 0x09, "       wma úúúúúúúú.úúú: ...............................  composer: ...............................                  time: ..:..    ", 132);
...
extern "C"
{
  cpifaceplayerstruct wmaPlayer = {wavOpenFile, wavCloseFile};
  char *dllinfo = "initclose _wmareg;";
};
